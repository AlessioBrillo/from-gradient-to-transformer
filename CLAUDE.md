...
## Project
Obsidian vault for AI engineering: from gradient descent (Phases 1-3) to Transformer (Phase 4), LLM Engineering (Phase 5), Production AI (Phase 6), and micro-LLM capstone (Phase 7). All content in English.
...
- Conventional Commits: `type(scope): message`
  ...
  - scopes: meta | phase1..7 | ci | portfolio | templates | scripts
