...
- [[03_progress-log]] — dated learning journal
...
- [[07_micro-phase-08-evidence-pass]] — root causes found, evidence produced
- [[08_micro-phase-09-the-flagship-runs]] — MP9 pre-registration (2026-08-02): predictions written before the runs
- [[08_micro-phase-09-flagship-sprint]] — MP9 as executed (2026-08-05): the eight-step sprint
...
- [[26_micro-phase-27-the-unblock|MP-27 · The Unblock]] — the phase
...
- [[32_micro-phase-33-the-second-question|MP-33 · The Second Question (pre-registered)]] —
  ...
  merge + 14 days
- [[33_micro-phase-34-the-third-question|MP-34 · The Third Question (pre-registered)]] —
  consumes MP-33's release whatever its rows decided (gated hard: no continuum ledger
  at zero, no phase): the continuum law executes a third time under a new ledger
  (ADR-0008) — exactly one new research question opens from the frozen candidate set
  C9–C12 (the unchosen close with dated reasons in the same sitting), the second
  research question's verdict consumed as an artifact, the paper v4 opens only for
  new numbers (else "the v3 is the record"), the essay annex v4, the shelf's year two
  at zero, the stranger round 4 with its kill-date, the debt rows re-verified with
...
- [[39_micro-phase-39-review-and-roadmap|MP-39 · Review + Roadmap (companion)]] —
  my state review and step-by-step plan for the eighth question, written from
  the seventh release report; companion to MP-38's review and roadmap, it opens
  no rows until Session 0 and is not counted against any cap (the cap is spent)
- [[40_micro-phase-40-review-and-roadmap|MP-40 · Review + Roadmap (companion)]] —
  my state review and step-by-step plan for the ninth question, written from
  the eighth release report; companion to MP-39's review and roadmap, it opens
  no rows until Session 0 and is not counted against any cap (the cap is spent)
- [[41_micro-phase-41-review-and-roadmap|MP-41 · Review + Roadmap (companion)]] —
  my state review and step-by-step plan for the tenth question, written from
  the ninth release report; companion to MP-40's review and roadmap, it opens
  no rows until Session 0 and is not counted against any cap (the cap is
  spent)
- [[42_micro-phase-42-review-and-roadmap|MP-42 · Review + Roadmap (companion)]] —
  my state review and step-by-step plan for the eleventh question, written
  from the tenth release report; companion to MP-41's review and roadmap, it
  opens no rows until Session 0 and is not counted against any cap (the cap
  is spent)
- [[43_micro-phase-43-review-and-roadmap|MP-43 · Review + Roadmap (companion)]] —
  my state review and step-by-step plan for the twelfth question, written
  from the eleventh release report; companion to MP-42's review and roadmap,
  it opens no rows until Session 0 and is not counted against any cap (the
  cap is spent)
- [[44_micro-phase-44-review-and-roadmap|MP-44 · Review + Roadmap (companion)]] —
  my state review and step-by-step plan for the thirteenth question, written
  from the twelfth release report; companion to MP-43's review and roadmap,
  it opens no rows until Session 0 and is not counted against any cap (the
  cap is spent)
- [[45_micro-phase-45-review-and-roadmap|MP-45 · Review + Roadmap (companion)]] —
  my state review and step-by-step plan for the fourteenth question, written
  from the thirteenth release report; companion to MP-44's review and
  roadmap, it opens no rows until Session 0 and is not counted against any
  cap (the cap is spent)
- [[46_micro-phase-46-review-and-roadmap|MP-46 · Review + Roadmap (companion)]] —
  my state review and step-by-step plan for the fifteenth question, written
  from the fourteenth release report; companion to MP-45's review and
  roadmap, it opens no rows until Session 0 and is not counted against any
  cap (the cap is spent)
- [[47_micro-phase-47-review-and-roadmap|MP-47 · Review + Roadmap (companion)]] —
  my state review and step-by-step plan for the sixteenth question, written
  from the fifteenth release report; companion to MP-46's review and
  roadmap, it opens no rows until Session 0 and is not counted against any
  cap (the cap is spent)
- [[48_micro-phase-48-review-and-roadmap|MP-48 · Review + Roadmap (companion)]] —
  my state review and step-by-step plan for the seventeenth question, written
...
- [[49_micro-phase-49-review-and-roadmap|MP-49 · Review + Roadmap (companion)]] —
  my state review and step-by-step plan for the eighteenth question, written
  from the seventeenth release report; companion to MP-48's review and
  execution roadmaps, it opens no rows until Session 0 and is not counted
  against any cap (the cap is spent)
- [[50_micro-phase-50-review-and-roadmap|MP-50 · Review + Roadmap (companion)]] —
  my state review and step-by-step plan for the nineteenth question, written
  from the eighteenth release report; companion to MP-49's review and
  roadmap, it opens no rows until Session 0 and is not counted against any
  cap (the cap is spent)
- [[51_micro-phase-51-review-and-roadmap|MP-51 · Review + Roadmap (companion)]] —
  my state review and step-by-step plan for the twentieth question, written
  from the nineteenth release report; companion to MP-50's review and
  roadmap, it opens no rows until Session 0 and is not counted against any
  cap (the cap is spent)
- [[52_micro-phase-52-review-and-roadmap|MP-52 · Review + Roadmap (companion)]] —
  my state review and step-by-step plan for the twenty-first question, written
  from the twentieth release report; companion to MP-51's review and
  roadmap, it opens no rows until Session 0 and is not counted against any
  cap (the cap is spent)
- [[53_micro-phase-53-review-and-roadmap|MP-53 · Review + Execution Roadmap (Architect's Review, companion)]] —
  my state review and step-by-step plan for the twenty-second question,
  written from the twenty-first release report from the reviewer's chair;
  companion to MP-52's review and roadmap, it opens no rows until Session 0
  and is not counted against any cap (the cap is spent)
- [[54_micro-phase-54-review-and-roadmap|MP-54 · Review + Execution Roadmap (Architect's Review, companion)]] —
  my state review and step-by-step plan for the twenty-third question,
  written from the twenty-second release report from the reviewer's chair;
  companion to MP-53's review and roadmap, it opens no rows until Session 0
  and is not counted against any cap (the cap is spent)
- [[55_micro-phase-55-review-and-roadmap|MP-55 · Review + Execution Roadmap (Architect's Review, companion)]] —
  my state review and step-by-step plan for the twenty-fourth question,
  written from the twenty-third release report from the reviewer's chair;
  companion to MP-54's review and roadmap, it opens no rows until Session 0
  and is not counted against any cap (the cap is spent)
- [[56_micro-phase-56-review-and-roadmap|MP-56 · Review + Execution Roadmap (Architect's Review, companion)]] —
  my state review and step-by-step plan for the twenty-fifth question,
  written from the twenty-fourth release report from the reviewer's chair;
  companion to MP-55's review and roadmap, it opens no rows until Session 0
  and is not counted against any cap (the cap is spent)
- [[57_micro-phase-57-review-and-roadmap|MP-57 · Review + Execution Roadmap (Architect's Review, companion)]] —
  my state review and step-by-step plan for the twenty-sixth question,
  written from the twenty-fifth release report from the reviewer's chair;
  companion to MP-56's review and roadmap, it opens no rows until Session 0
  and is not counted against any cap (the cap is spent)
- [[58_micro-phase-58-review-and-roadmap|MP-58 · Review + Execution Roadmap (Architect's Review, companion)]] —
  my state review and step-by-step plan for the twenty-seventh question,
  written from the twenty-sixth release report from the reviewer's chair;
  companion to MP-57's review and roadmap, it opens no rows until Session 0
  and is not counted against any cap (the cap is spent)
- [[59_micro-phase-59-review-and-roadmap|MP-59 · Review + Execution Roadmap (Architect's Review, companion)]] —
  my state review and step-by-step plan for the twenty-eighth question,
  written from the twenty-seventh release report from the reviewer's chair;
  companion to MP-58's review and roadmap, it opens no rows until Session 0
  and is not counted against any cap (the cap is spent)
- [[60_micro-phase-60-review-and-roadmap|MP-60 · Review + Execution Roadmap (Architect's Review, companion)]] —
  my state review and step-by-step plan for the twenty-ninth question,
  written from the twenty-eighth release report from the reviewer's chair;
  companion to MP-59's review and roadmap, it opens no rows until Session 0
  and is not counted against any cap (the cap is spent)
- [[61_micro-phase-61-review-and-roadmap|MP-61 · Review + Execution Roadmap (Architect's Review, companion)]] —
  my state review and step-by-step plan for the thirtieth question,
  written from the twenty-ninth release report from the reviewer's chair;
  companion to MP-60's review and roadmap, it opens no rows until Session 0
  and is not counted against any cap (the cap is spent)
- [[62_micro-phase-62-review-and-roadmap|MP-62 · Review + Execution Roadmap (Architect's Review, companion)]] —
  my state review and step-by-step plan for the thirty-first question,
  written from the thirtieth release report from the reviewer's chair;
  companion to MP-61's review and roadmap, it opens no rows until Session 0
  and is not counted against any cap (the cap is spent)
- [[63_micro-phase-63-review-and-roadmap|MP-63 · Review + Execution Roadmap (Architect's Review, companion)]] —
  my state review and step-by-step plan for the thirty-second question,
  written from the thirty-first release report from the reviewer's chair;
  companion to MP-62's review and roadmap, it opens no rows until Session 0
  and is not counted against any cap (the cap is spent)
- [[64_micro-phase-64-review-and-roadmap|MP-64 · Review + Execution Roadmap (Architect's Review, companion)]] —
  my state review and step-by-step plan for the thirty-third question,
  written from the thirty-second release report from the reviewer's chair;
  companion to MP-63's review and roadmap, it opens no rows until Session 0
  and is not counted against any cap (the cap is spent)
- [[65_micro-phase-65-review-and-roadmap|MP-65 · Review + Execution Roadmap (Architect's Review, companion)]] —
  my state review and step-by-step plan for the thirty-fourth question,
  written from the thirty-third release report from the reviewer's chair;
  companion to MP-64's review and roadmap, it opens no rows until Session 0
  and is not counted against any cap (the cap is spent)
- [[66_micro-phase-66-review-and-roadmap|MP-66 · Review + Execution Roadmap (Architect's Review, companion)]] —
  my state review and step-by-step plan for the thirty-fifth question,
  written from the thirty-fourth release report from the reviewer's chair;
  companion to MP-65's review and roadmap, it opens no rows until Session 0
  and is not counted against any cap (the cap is spent)
- [[67_micro-phase-67-review-and-roadmap|MP-67 · Review + Execution Roadmap (Architect's Review, companion)]] —
  my state review and step-by-step plan for the thirty-sixth question,
...
- [[68_micro-phase-68-review-and-roadmap|MP-68 · Review + Execution Roadmap (Architect's Review, companion)]] —
  ...
  and is not counted against any cap (the cap is spent)
- [[69_micro-phase-69-review-and-roadmap|MP-69 · Review + Execution Roadmap (Architect's Review, companion)]] —
  my state review and step-by-step plan for the thirty-eighth question,
...
- [[82_micro-phase-82-from-debt-to-verdict|MP-82 · From Debt to Verdict (ACTIVE EXECUTION)]] —
  I freeze the shakedown invocation (`--steps 2000 --warmup-steps 100 --checkpoint-every 500 --save-model --manifest-path results/probe_capstone_shakedown.json`), land the unequal-tail and manifest-integration tests, fix portfolio prose drift and link orphaned figures, and execute ADR-0028 Rows 1–8. No new roadmap until ADR-0028 hits zero unstamped rows. Terminus: Session 6 release.
- [[83_micro-phase-83-from-invocation-to-evidence|MP-83 · From Invocation to Evidence (ACTIVE EXECUTION)]] —
...
- [[86_micro-phase-86-from-stamps-to-record|MP-86 · From Stamps to Record (ACTIVE EXECUTION)]] —
...
- [[93_micro-phase-93-solution-regime-phase-diagram|MP-93 · Solution-Regime Phase Diagram (PLANNING)]] —
...
- [[35_micro-phase-36-the-fifth-question|MP-36 · The Fifth Question (pre-registered)]] —
  ...
  (ADR-0010) — exactly one new research question opens from the frozen candidate set
  C17–C20 (the unchosen close with dated reasons in the same sitting; likely survivor
  C18, the dense→memorized transition), the fourth research question's verdict
  consumed as an artifact, the paper v6 opens only for new numbers (else "the v5 is
  the record"), the essay annex v6, the shelf's year four at zero, the stranger round
  6 with its kill-date, the debt rows re-verified with transcripts (the exp5
  1000-epoch resolution's receipt), and the teaching lane ships its fourth runnable
  artifact a stranger can execute; release = merge + 14 days

## Phases
- [[01_foundations/_MOC|Phase 1 · Foundations]]
- [[02_classical_ml/_MOC|Phase 2 · Classical ML]]
- [[03_deep_learning/_MOC|Phase 3 · Deep Learning]]
