...
|---|---|---|---|---|---|---|
| 1 | P=113 grokking, ×3 seeds, Colab GPU via `notebooks/colab_grokking_full_run.ipynb` (Rung 2 — primary flagship) | UNDECIDED | — | Window: S1–S4 · heartbeat: checkpoint-every-500 + resume | Grok = val acc ≥ 0.95 sustained ≥ 5 checkpoints AND Fourier frequency count < P/2 sustained; generalization epoch reported | No grok by 5000 epochs with wd and cosine as pinned → microscope lane (row 2) |
