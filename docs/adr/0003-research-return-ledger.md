...
|---|---|---|---|---|---|---|
| 1 | P=113 grokking, ×3 seeds, CPU-first via this machine's overnight budget (ADR-0003 row 1 frozen protocol; Colab GPU no longer load-bearing) (Rung 2 — primary flagship) | LAUNCHED (2026-08-11, **NO-GROK**: val=1.0 sustained but Fourier dense, k_99=111/113; gen epochs 1250/1048/1326) | 2026-08-11 | Window: S1–S4 · heartbeat: checkpoint-every-500 + resume, `checkpoints/heartbeat.md` | Grok = val acc ≥ 0.95 sustained ≥ 5 checkpoints AND Fourier frequency count < P/2 sustained; generalization epoch reported | No grok by 5000 epochs with wd and cosine as pinned → microscope lane (row 2) |
| 2 | Fallback lane: the one-change microscope (≤ 3 single-variable trials, negative controls) | LAUNCHED (2026-08-11, in flight: trial 1 `--no-normalize-embeddings`, P=113 single seed) | 2026-08-11 | Window: S3 · ≤ 3 bullets: embedding re-norm · cosine schedule · my own third | Verdict = the trial that groks, or the dated negative with the trial results table | Third failed trial → row closes with one reason |
