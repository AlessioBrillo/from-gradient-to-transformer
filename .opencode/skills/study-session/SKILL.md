...
- **How it works:** explanation with concrete example, diagram (ASCII or description), or minimal code
- **Links:** at least 2 wikilinks to existing notes (use `_MOC.md` files as starting points). Link to related phases.
