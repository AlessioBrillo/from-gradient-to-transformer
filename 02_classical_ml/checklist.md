...
- [ ] Support Vector Machines: maximum margin, kernel trick — **forward link: circuit intuition (attention separability)**
...
- [ ] Feature engineering: encoding, scaling, interactions
- [ ] Data leakage: detection and prevention
- [ ] PCA: implementation, variance explanation, connection to SAEs
