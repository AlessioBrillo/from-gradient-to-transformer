...
## Phase gate
- [x] **Proof passed** → I can move to the next phase. (gate proof: [[02_classical_ml/proofs/complete-ml-pipeline]])
...
- [x] Gradient boosting: XGBoost/LightGBM hands-on (note: [[02_classical_ml/notes/gradient-boosting]], exercise: [[02_classical_ml/exercises/ex-04-gradient-boosting-and-naive-bayes]])
...
- [x] Naive Bayes: probabilistic classifier, conditional independence assumption (note: [[02_classical_ml/notes/naive-bayes]], exercise: [[02_classical_ml/exercises/ex-04-gradient-boosting-and-naive-bayes]])
